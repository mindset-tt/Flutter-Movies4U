...
class SifiMovieRow extends StatelessWidget {
  ...
  Widget getView(BuildContext context, int index, jsonResult) {
    if (jsonResult is MovieImgRespo) {
      ...
      // return getLargeItem(
      //     context: context,
      //     img:(sizeInfo.deviceScreenType == DeviceScreenType.desktop?ApiConstant.imageoriginposter:ApiConstant.imageposter) +  item.filePath,
      //     screenSpace: 80,
      //     sizeInfo:sizeInfo,
      //     tag: tag,
      //     onTap: () => navigationPush(
...
//              return getLargeItem(
//                  context: context,
//                  img: ApiConstant.imageposter + item.filePath,
//                  tag: tag,
//                  onTap: () => navigationPush(
